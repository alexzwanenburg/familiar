...
testthat::test_that("Random forest SRC model cannot predict if data is empty", {
...
testthat::test_that("Random forest SRC can predict single samples", {
...
testthat::test_that("Random forest SRC model can train on single features", {
...
testthat::test_that("Random forest SRC model does not train for bad data with one class only", {
...
# Train the model using the bad data (classes missing).
bad_model <- familiar:::train(data=bad_data,
                              cluster_method="none",
                              imputation_method="simple",
                              hyperparameter_list=list("sign_size"=familiar:::get_n_features(bad_data),
...
testthat::test_that("Random forest SRC model does not train for bad data with missing classes", {
...
testthat::test_that("Random forest SRC model can predict risk", {
...
testthat::test_that("Random forest SRC model can predict survival probabilities", {
...
testthat::test_that("Random forest SRC model does not train for bad data with all censoring", {
