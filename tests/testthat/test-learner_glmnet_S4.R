...
testthat::test_that("Regularised regression model can predict values", {
...
testthat::test_that("Regularised regression model cannot predict if data is empty", {
...
testthat::test_that("Regularised regression model can predict single samples", {
...
testthat::test_that("Regularised regression model can train on single features", {
...
testthat::test_that("Regularised regression model does not train for bad data with one class only", {
...
testthat::test_that("Regularised regression model can predict class probabilities", {
...
testthat::test_that("Regularised regression model does not train for bad data with missing classes", {
...
testthat::test_that("Regularised regression model can predict risk", {
...
testthat::test_that("Regularised regression model can predict survival probabilities", {
...
testthat::test_that("Regularised regression model does not train for bad data with all censoring", {
