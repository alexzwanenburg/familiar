...
testthat::test_that("Ranger random forest model has variable importance", {
  ...
  # Expect that cell_size_uniformity has rank 1 and clump_thickness has rank 2.
  testthat::expect_equal(vimp_table[rank == 1, ]$name, "cell_size_uniformity")
...
testthat::test_that("Ranger random forest model does not train for bad data with missing classes", {
