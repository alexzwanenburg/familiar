...
testthat::test_that("Naive Bayes model does not have variable importance", {
...
testthat::test_that("Naive Bayes model can predict class probabilities", {
  
  # Extract the prediction table.
  prediction_table <- suppressWarnings(familiar:::.predict(good_model, data=good_data))
...
testthat::test_that("Naive Bayes model cannot predict if data is empty", {
...
testthat::test_that("Naive Bayes model can predict single samples", {
...
testthat::test_that("Naive Bayes model can train on single features", {
...
testthat::test_that("Naive Bayes model does not train for bad data with one class only", {
...
testthat::test_that("Naive Bayes model does not train for bad data with missing classes", {
