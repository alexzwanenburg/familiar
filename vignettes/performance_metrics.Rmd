...
many metrics that typically used to assess the performance of categorical,
...
: Overview of performance metrics for categorical outcomes. Some contingency
...
-   `micro`: The number of true positives, true negatives, false positives and
    ...
    all classes. The score is subsequently calculated.
...
pairs of values is determined as follows *reference missing*:
