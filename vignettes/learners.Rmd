...
Hence we use $\beta_t= {2 \over 5} \log\left({5 \over 3}|D|(t+1)^2\pi^2\right)$.
...
number of bootstraps already performed for any of the hyperparameter sets. Hence
our implementation is actually the same, aside from the lack of constraint on
the posterior distribution. Based on the simulations and recommendations by
