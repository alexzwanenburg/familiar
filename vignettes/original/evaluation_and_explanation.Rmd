...
```{r, results=FALSE, eval=TRUE, message=FALSE, warning=FALSE, label="breast-data-preparation"}
# Get a dataset.
...
model_path <- file.path(
  ...
  list.files(model_directory_path, pattern = "model")[1L]
)
...
```{r, results=FALSE, eval=TRUE, message=FALSE, warning=FALSE, label="colon-data-preparation"}
# Get a dataset.
...
```{r, fig.align='center', fig.width=7, label="decision-curve-bci"}
...
```{r, fig.align='center', fig.width=7, label="model-variable-importance"}
...
```{r, fig.align='center', fig.width=7, label="permutation-variable-importance-bc-spearman"}
plots <- familiar::plot_permutation_variable_importance(
  object = binomial_model,
  data = binomial_data,
  estimation_type = "bias_correction",
...
```{r, fig.align='center', fig.width=7, label="ice-cell-shap-uniformity"}
...
```{r, fig.align='center', fig.width=7, label="ice-cell-shape-uniformity-anchored"}
plots <- familiar::plot_ice(
  object = binomial_model,
  data = binomial_data,
  features = "cell_shape_uniformity",
...
```{r, fig.align='center', fig.width=7, label="ice-2d-survival"}
plots <- familiar::plot_ice(
  object = survival_model,
  data = survival_data,
  features = c("nodes", "rx"),
